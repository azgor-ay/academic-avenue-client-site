    ...
    <div className="grid grid-cols-2">
      ...
      <div className="my-auto mx-auto mr-12">
        <p>
          ...
          the college admission landscape. Since its establishment in 2023, this
          platform has been a guiding light for thousands of students, including
          many I've had the pleasure of mentoring. Academic Avenue's commitment
          to simplifying the application process and providing comprehensive
          college information has helped over 3000 students find their perfect
          match.
          </p>
<br />
          <p>
